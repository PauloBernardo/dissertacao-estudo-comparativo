...
\midrule
\textbf{Tier 2 (em andamento)} & 18 modelos, 6 datasets, $N{=}5000$, 30s & 3240 & ADULT, CREDIT, BANK, TELCO, SHOPPERS, HIGGS50K \\
\midrule
\bottomrule
\end{tabular}}
\end{table}
...
\begin{enumerate}\sloppy
  \item \textbf{Tier 2} (em andamento): benchmarks CREDIT (30k), ADULT (48k)
        e HIGGS50K com os modelos escaláveis (Nyström-SVM, FT-CUR, variantes
        FT-Transformer), executados no Google Colab (GPU T4).
  ...
  \item \textbf{Análise de complexidade temporal}: medição do speedup do
        Nyström-SVM vs.\ LSSVM-Std em função de $n$ (Tier~2 fornece dados reais
        para essa curva).
\end{enumerate}
