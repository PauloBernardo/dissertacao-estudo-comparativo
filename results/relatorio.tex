...
Grid+CV completo (30 sementes) nos 12 modelos LSSVM+XGBoost sobre os
datasets 5D (TWS\_5f, TWM\_5f, TWC\_5f). Resultados de Transformers pendentes.

\input{tables/ablation_b.tex}
...
Grid+CV completo, 30 sementes, 12 modelos LSSVM+XGBoost.
Resultados de Transformers pendentes.

\input{tables/ablation_c.tex}
