...
References for the grids:
    ...
    - ADMM-N λ, λ₂ : Marinho et al. observed range
                     0.034–1.20 → grid [0.01, 0.1, 1, 10].
...
GRIDS: dict[str, dict] = {
    ...
    # Orientador's priority: num_blocks and num_heads only.
    # Other hyperparameters fixed at Gorishniy 2021 defaults.
    ...
    # Use val_loss for early stopping (H2 ablation result, p < 1e-5).
