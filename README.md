...
O fluxo ativo e verificável no código atual para Tier 1 é:
...
3. analisar os artefatos em `results/`
...
- Python 3.11+
- `xgboost` instalado explicitamente
...
Observação: `xgboost` é usado por [src/models/xgboost_wrapper.py](/home/paulo/IdeaProjects/dissertacao-estudo-comparativo/src/models/xgboost_wrapper.py) mas hoje não está listado em `pyproject.toml` nem em `requirements.txt`.
...
O protocolo atual está implementado em [scripts/run_tier1_gridcv.py](/home/paulo/IdeaProjects/dissertacao-estudo-comparativo/scripts/run_tier1_gridcv.py):
...
Por padrão, o script roda todos os variants definidos em [src/tuning/grids.py](/home/paulo/IdeaProjects/dissertacao-estudo-comparativo/src/tuning/grids.py) sobre os 9 datasets do Tier 1 e 30 seeds.
